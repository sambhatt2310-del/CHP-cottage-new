...
<div class="widget wpte-booking-area-wrapper wpte-bf-outer <?php echo esc_attr( $wrapper_classes ); ?>">
	...
	<div class="wpte-booking-area<?php echo esc_attr( $class_based_on_layout ); ?>">
		...
		<button data-text="<?php  echo $form_layout == 'layout-3' ? esc_attr( $currency_symbol ): '' ?>" type="button" id="wpte_price-toggle-btn-mb" class="wpte_price-toggle-btn-mb" data-active-text="<?php $form_layout == 'layout-1' ? esc_html_e( 'Hide Prices', 'wp-travel-engine' ) : ''; ?>">
			<?php if ( $form_layout == 'layout-1' ) : ?>
				<span class="current-text">
					<?php esc_html_e( 'Show Prices', 'wp-travel-engine' ); ?>
				</span>
			<?php endif; ?>
		</button>
