			...
			<div class="wpte-block-content">
				<ul>
					...
					<li>
						...
						<span>
							<?php echo wp_kses( \wte_get_formated_price( $tax_amount[ 'tax_actual' ] ), 'allowed_price_html' ); ?>
						</span>
					</li>
					<b><?php esc_html_e( 'Total:', 'wp-travel-engine' ); ?></b>
					<span>
						<?php echo wp_kses( \wte_get_formated_price( $tax_amount[ 'new_totalcost' ] ), 'allowed_price_html' ); ?>
					</span>
					</li>
					<?php
					// }
