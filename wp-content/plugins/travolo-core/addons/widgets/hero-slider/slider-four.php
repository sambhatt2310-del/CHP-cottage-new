 ...
 *
 */
class Travolo_Hero_Four extends Widget_Base {

	public function get_name() {
		return 'travoloherofour';
	}

	public function get_title() {
		return __( 'Hero Home Four', 'travolo' );
	}
	...
	protected function render() {
		...
		echo '<section class="hero-layout5">';
...
$widgets_manager->register( new \Travolo_Hero_Four() );
