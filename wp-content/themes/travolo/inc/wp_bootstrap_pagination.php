...
function travolo_pagination( $args = array() ) {
    $allowhtml = array(
    	'p'         => array(
    		'class'     => array()
    	),
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'travolo' ),
        'next_string'     => esc_html__( '&raquo;', 'travolo' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args(
        $args,
        apply_filters( 'travolo_pagination_defaults', $defaults )
    );
