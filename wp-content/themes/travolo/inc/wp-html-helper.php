...
// image default alt
if( !function_exists( 'travolo_img_default_alt' ) ){
	function travolo_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'travolo_img_tag' ) ){
	function travolo_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = travolo_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'travolo_anchor_tag' ) ){
	function travolo_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'travolo_heading_tag' ) ){
	function travolo_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'travolo_paragraph_tag' ) ){
	function travolo_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'travolo_span_tag' ) ){
	function travolo_span_tag( array $args ){
