...
function travolo_fa_icons( $html = '' ){
  $icons = array(
	'fa-glass'=>'&#xf000;  fa-glass',
	'fa-music'=>'&#xf001;  fa-music',
	'fa-search'=>'&#xf002;  fa-search',
...
// the opt_name is set to travolo_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/travolo_opt/enqueue', 'travolo_faIconFont' );
function travolo_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', TRAVOLO_DIR_CSS_URI.'font-awesome.min.css', array(), '4.7.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'travolo-redux-admin', TRAVOLO_DIR_URI.'inc/redux-custom-field/assets/travolo.redux.admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'travolo-redux-admin', TRAVOLO_DIR_URI.'inc/redux-custom-field/assets/travolo.redux.admin.js', array( 'jquery' ), '1.0', true );
