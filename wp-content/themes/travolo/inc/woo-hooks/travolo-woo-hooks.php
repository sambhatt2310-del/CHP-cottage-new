...
add_filter( 'loop_shop_per_page', 'travolo_new_loop_shop_per_page', 20 );
function travolo_new_loop_shop_per_page( $product_count ) {
  $product_count = travolo_opt( 'travolo_woo_product_perpage' );
...
add_filter('woocommerce_product_loop_start','travolo_woocommerce_product_loop_start');
function travolo_woocommerce_product_loop_start( ) {
    echo '<div class="row">';
}

// wooocommerce product loop start filter
add_filter('woocommerce_product_loop_end','travolo_woocommerce_product_loop_end');
function travolo_woocommerce_product_loop_end( ) {
    echo '</div>';
}

// woocommerce format sale price
add_filter('woocommerce_format_sale_price','travolo_woocommerce_format_sale_price',10,3);
function travolo_woocommerce_format_sale_price( $price, $regular_price, $sale_price ) {
...
add_filter('woocommerce_review_gravatar_size','travolo_woocommerce_review_gravatar_size');
function travolo_woocommerce_review_gravatar_size() {
    return 65;
}
...
add_filter('woocommerce_output_related_products_args','travolo_woocommerce_output_related_products_args',10,1);
function travolo_woocommerce_output_related_products_args( $args ) {
    if( class_exists('ReduxFramework') ) {
        $args['posts_per_page'] = travolo_opt('travolo_woo_relproduct_num');
    } else {
...
add_filter('woocommerce_upsell_display_args','travolo_woocommerce_upsell_display_args',10,1);
function travolo_woocommerce_upsell_display_args( $args ) {
    if( class_exists('ReduxFramework') ) {
        $args['posts_per_page'] = travolo_opt('travolo_woo_upsellproduct_num');
    } else {
        $args['posts_per_page'] = '3';
    }
    return $args;
...
function woocommerce_cross_sells_total( $limit ) {
    if( class_exists('ReduxFramework') ) {
        $limit = travolo_opt('travolo_woo_crosssellproduct_num');
    } else {
        $limit = '3';
    }
...
// Ajax Cart Count
add_filter( 'woocommerce_add_to_cart_fragments', 'travolo_refresh_mini_cart_count');
function travolo_refresh_mini_cart_count($fragments){
    ob_start();
    ?>
...
// Checkout fields
add_filter( 'woocommerce_checkout_fields' , 'travolo_override_checkout_fields' );
function travolo_override_checkout_fields( $fields  ){
    ...
    $fields['billing']['billing_first_name']['placeholder'] = esc_attr__('First Name', 'travolo');
    ...
    $fields['billing']['billing_email']['placeholder'] = esc_attr__('Email address', 'travolo');
    ...
    $fields['billing']['billing_city']['placeholder'] = esc_attr__('Town / City', 'travolo');
    ...
    $fields['billing']['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'travolo');
    ...
    $fields['shipping']['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'travolo');
    ...
    $fields['shipping']['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'travolo');
    ...
    $fields['shipping']['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'travolo');
    ...
    $fields['shipping']['shipping_phone']['placeholder'] = esc_attr__('Phone', 'travolo');
    ...
    $fields['shipping']['shipping_email']['placeholder'] = esc_attr__('Email address', 'travolo');
    ...
    $fields['shipping']['shipping_city']['placeholder'] = esc_attr__('Town / City', 'travolo');
    ...
    $fields['shipping']['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'travolo');
...
add_filter( 'woocommerce_default_address_fields', 'travolo_override_default_locale_fields' );
function travolo_override_default_locale_fields( $fields ) {
...
add_filter( 'woocommerce_billing_fields' , 'travolo_custom_billing_fields' );
function travolo_custom_billing_fields( $fields ) {
    ...
    $fields['billing_first_name']['placeholder'] = esc_attr__('First Name', 'travolo');
    ...
    $fields['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'travolo');
    ...
    $fields['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'travolo');
    ...
    $fields['billing_phone']['placeholder'] = esc_attr__('Phone', 'travolo');
    ...
    $fields['billing_email']['placeholder'] = esc_attr__('Email address', 'travolo');
    ...
    $fields['billing_city']['placeholder'] = esc_attr__('Town / City', 'travolo');
    ...
    $fields['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'travolo');
...
add_filter( 'woocommerce_shipping_fields' , 'travolo_custom_shipping_fields' );
function travolo_custom_shipping_fields( $fields ) {

    // Shipping Fields

    $fields['shipping_first_name']['class'] = array('col-lg-6');
    $fields['shipping_first_name']['input_class'] = array('form-control');
    $fields['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'travolo');
    ...
    $fields['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'travolo');
    ...
    $fields['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'travolo');
    ...
    $fields['shipping_phone']['placeholder'] = esc_attr__('Phone', 'travolo');
    ...
    $fields['shipping_email']['placeholder'] = esc_attr__('Email address', 'travolo');
    ...
    $fields['shipping_city']['placeholder'] = esc_attr__('Town / City', 'travolo');
    ...
    $fields['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'travolo');
...
add_action( 'woocommerce_before_main_content', 'travolo_shop_col_start_cb', 10 );

// Shop column end wrapper hook
add_action('woocommerce_after_main_content','travolo_shop_col_end_cb',10);

// Category Section Start
add_action( 'travolo_shop_categorysection_start', 'travolo_shop_categorysection_start_cb', 10 );

// shop main content hook
add_action('travolo_shop_main_content','travolo_shop_main_content_cb',10);

// shop main content end hook
add_action('travolo_shop_main_content_end','travolo_shop_main_content_end_cb',10);

// travolo woocommerce pagination hook
add_action('woocommerce_after_shop_loop','travolo_woocommerce_pagination',10);

// travolo woocommerce filter wrapper hook
add_action('woocommerce_before_shop_loop','travolo_woocommerce_filter_wrapper',20);

// travolo woocommerce product content wrapper
add_action('travolo_woocommerce_product_content', 'travolo_grid_tab_content_cb', 10 );

// travolo woocommerce get sidebar
add_action('woocommerce_sidebar','travolo_woocommerce_get_sidebar',10);

/*
*   Content Product Hook
*/

// travolo shop loop product thumbnail hook
add_action( 'woocommerce_before_shop_loop_item', 'travolo_loop_product_thumbnail', 10 );

// travolo shop loop hozrizontal product thumbnail hook
add_action( 'woocommerce_before_shop_horizontal_loop_item', 'travolo_loop_product_thumbnail', 10 );

// travolo shop loop product summary hook
add_action( 'woocommerce_after_shop_loop_item', 'travolo_loop_product_summary', 10 );

// travolo shop loop horizontal product summary hook
add_action('woocommerce_after_shop_horizonal_loop_item', 'travolo_horizontal_loop_product_summary' );

// travolo shop loop horizontal product summary hook
add_action('travolo_woocommerce_shop_three_loop_product_summary','travolo_woocommerce_shop_three_loop_product_summary_cb',10);
...
add_action('woocommerce_single_product_summary', 'travolo_woocommerce_single_product_price_rating', 10 );

// single product title
add_action('woocommerce_single_product_summary', 'travolo_woocommerce_single_product_title', 10 );


// single product excerpt
add_action('woocommerce_single_product_summary', 'travolo_woocommerce_single_product_excerpt', 40 );

// single product availability
add_action( 'woocommerce_single_product_summary', 'travolo_woocommerce_single_product_availability', 50 );

// single product add to cart button
add_action('woocommerce_single_product_summary','travolo_woocommerce_single_add_to_cart_button',60);

// single product meta hook
add_action('woocommerce_single_product_summary','travolo_woocommerce_single_meta',80);

// single product sidebar
add_action('travolo_woocommerce_single_product_sidebar','travolo_woocommerce_single_product_sidebar_cb');

// single product price and rating
add_action('travolo_quickview_single_product_summary','travolo_woocommerce_single_product_price_rating',20);

// single product title
add_action('travolo_quickview_single_product_summary','travolo_woocommerce_quickview_single_product_title',30);

// single product excerpt
add_action('travolo_quickview_single_product_summary','travolo_woocommerce_single_product_excerpt',40);

// single product add to cart button
add_action('travolo_quickview_single_product_summary','travolo_woocommerce_single_add_to_cart_button',60);
...
add_action('woocommerce_review_before_comment_meta','travolo_woocommerce_reviewer_meta',10,1);
...
add_action('woocommerce_proceed_to_checkout','travolo_woocommerce_button_proceed_to_checkout',20);

// cross sell products
add_action('woocommerce_after_cart','travolo_woocommerce_cross_sell_display',10);

// mini cart view cart button
add_action('woocommerce_widget_shopping_cart_buttons','travolo_minicart_view_cart_button',10);

// mini cart checkout button
add_action('woocommerce_widget_shopping_cart_buttons','travolo_minicart_checkout_button',20);

/*
*   checkout hook
*/

// travolo woocommerce checkout login form
add_action('woocommerce_before_checkout_form','travolo_woocommerce_before_checkout_form',10);
...
add_filter( 'woosc_button_html', 'travolo_woosc_button_html', 10, 2 );
function travolo_woosc_button_html( $output , $prodid ) {
...
add_filter( 'woosc_button_text_added', 'travolo_woo_compare_btn_text_added', 10, 2 );
function travolo_woo_compare_btn_text_added( ){
    return $output = '<i class="fal fa-layer-group"></i>';
}

add_filter( 'woosc_button_text', 'travolo_compare_btn_text', 10, 2 );
function travolo_compare_btn_text(){
    return $output = '<i class="fal fa-layer-group"></i>';
}
...
add_filter( 'woosq_button_html', 'travolo_woosq_button_html', 10, 2 );
function travolo_woosq_button_html( $output , $prodid ) {
